...
class Carafity_Elementor_Button_Popup extends Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'icon_close',
            [
                'label'            => esc_html__('Close Icon', 'carafity'),
                'type'             => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
                'skin'             => 'inline',
                'default'          => [
                    'value'   => 'carafity-icon-close-menu',
                    'library' => 'carafity-icon',
                ],
                'label_block'      => false,
            ]
        );
        ...
        $this->add_responsive_control(
            'close_icon_size',
            [
                'label'     => esc_html__('Close Icon Size', 'carafity'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
                ...
                'selectors' => [
                    '.button-popup-content.button-popup-content-{{ID}} .mfp-close i ,.button-popup-content.button-popup-content-{{ID}} .mfp-close svg' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
