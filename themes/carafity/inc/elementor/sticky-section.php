...
class Carafity_Sticky_Module {
    ...
    public function scripts() {
        ...
        wp_register_script('elementor-sticky', get_template_directory_uri() . '/assets/js/vendor/elementor-sticky.js', ['jquery'], CARAFITY_VERSION, true);
        wp_enqueue_script('carafity-elementor-sticky', get_template_directory_uri() . '/assets/js/vendor/sticky.js', ['jquery', 'elementor-frontend', 'elementor-sticky'], CARAFITY_VERSION, true);
    }
    ...
    public function register_controls(Element_Base $element) {
        $element->add_control(
            'sticky',
            [
                'label'              => esc_html__('Sticky', 'carafity'),
        ...
        foreach ($active_devices as $device) {
            $label                          = 'desktop' === $device ? esc_html__('Desktop', 'carafity') : $active_breakpoint_instances[$device]->get_label();
        ...
        $element->add_control(
            'sticky_on',
            [
                'label'              => esc_html__('Sticky On', 'carafity'),
        ...
        $element->add_responsive_control(
            'sticky_offset',
            [
                'label'              => esc_html__('Offset', 'carafity'),
        ...
        $element->add_responsive_control(
            ...
            [
                'label'              => esc_html__('Effects Offset', 'carafity'),
                'type'               => Controls_Manager::NUMBER,
                'default'            => 0,
                'min'                => 0,
                'max'                => 1000,
        ...
        if ($this->is_instance_of($element, $types)) {
            ...
            $element->add_control(
                'sticky_parent',
                [
                    'label'              => esc_html__('Stay In Column', 'carafity'),
    ...
    public function register_controls_search_popup(Element_Base $element) {
        ...
        $element->add_control(
            'search_popup_parent',
            [
                'label'        => esc_html__('Parent search popup', 'carafity'),
                'type'         => Controls_Manager::SWITCHER,
