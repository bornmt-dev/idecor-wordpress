...
if (!class_exists('Carafity_WooCommerce')) :
    ...
    class Carafity_WooCommerce {
        ...
        public function woocommerce_scripts() {
            ...
            wp_enqueue_style('carafity-woocommerce-style', get_template_directory_uri() . '/assets/css/woocommerce/woocommerce.css', array(), CARAFITY_VERSION);
            wp_style_add_data('carafity-woocommerce-style', 'rtl', 'replace');

            if (defined('WC_VERSION') && version_compare(WC_VERSION, '3.3', '<')) {
                wp_enqueue_style('carafity-woocommerce-legacy', get_template_directory_uri() . '/assets/css/woocommerce/woocommerce-legacy.css', array(), CARAFITY_VERSION);
            ...
            if (is_shop() || is_product() || is_product_taxonomy()) {
                ...
                wp_enqueue_script('carafity-shop-select', get_template_directory_uri() . '/assets/js/woocommerce/shop-select' . $suffix . '.js', array('jquery'), CARAFITY_VERSION, true);
            ...
            wp_enqueue_script('carafity-input-quantity', get_template_directory_uri() . '/assets/js/woocommerce/quantity' . $suffix . '.js', array('jquery'), CARAFITY_VERSION, true);

            if (is_active_sidebar('sidebar-woocommerce-shop')) {
                wp_enqueue_script('carafity-off-canvas', get_template_directory_uri() . '/assets/js/woocommerce/off-canvas' . $suffix . '.js', array(), CARAFITY_VERSION, true);
            }
            wp_enqueue_script('carafity-cart-canvas', get_template_directory_uri() . '/assets/js/woocommerce/cart-canvas' . $suffix . '.js', array(), CARAFITY_VERSION, true);
            ...
            if (is_product()) {
                ...
                wp_register_script('carafity-countdown-single', get_template_directory_uri() . '/assets/js/woocommerce/single-countdown' . $suffix . '.js', array('jquery'), CARAFITY_VERSION, true);

                wp_enqueue_script('carafity-sticky-add-to-cart', get_template_directory_uri() . '/assets/js/sticky-add-to-cart' . $suffix . '.js', array(), CARAFITY_VERSION, true);
